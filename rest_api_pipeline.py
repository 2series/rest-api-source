    ...
    pokemon_source = rest_api_source(
        {
            ...
            "resource_defaults": {
                ...
                "write_disposition": "replace", # 'replace' will update config in the destination
            },
            "resources": [
                {
                    "name": "pokemon",
                    "primary_key": "id",
                    "write_disposition": "merge", # 'merge' on primary key will update config in the destination
                },
                "berry",
                "location",
            ],
